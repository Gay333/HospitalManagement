...
public class Patient_Medical_RecordController {
    ...
    @ResponseBody
    public Iterable<Patient_Medical_Record> findOnePatientMedicalRecord(@PathVariable String patient_ID, @PathVariable String type_of_patient, @PathVariable String Date_of_appointment){
    ...
    @ResponseBody
    public String deleteMedicalRecord(@PathVariable String patient_ID, @PathVariable String type_of_patient, @PathVariable String Date_of_appointment){

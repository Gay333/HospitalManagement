...
public interface Patient_Medical_RecordRepository extends CrudRepository<Patient_Medical_Record,Integer> {
    ...
    Iterable<Patient_Medical_Record> findMedical_Record(@Param("patient_ID") String patient_ID, @Param("type_of_patient") String type_of_patient,@Param("Date_of_appointment") String Date_of_appointment);
